...
# ----------------------------------------------------
# จุดที่ 3: สรุปผลการเล่นเกมใน MessageBox
...
def show_result_dialog(ans1, ans2, ans3, ans4):
    ...
    # จุดที่ 4: เพิ่มข้อ 3 และตรวจข้อ 4
    ...
    # จุดที่ 5: เพิ่มคะแนนเป็น 4 คะแนน
...
# ----------------------------------------------------
# จุดที่ 6: เพิ่มช่องรับคำตอบ ข้อ 3 และ ข้อ 4
...
ans3 = st.text_input(
    "ข้อ 3: I eat a `b _ n _ n _` every day. 🍌",
    value=st.session_state.ans3_val,
)

ans4 = st.text_input(
    "ข้อ 4: I like to eat `m _ n g _`. 🥭",
